...
/**
 * Provide feature of setting default encryption password
 * by invoking the <code>setDefaultPassword</code> method
 * when constructing the subclasses
 * 
 * @author Martin
 */
public class GBEnvironmentStringPBEConfig extends EnvironmentStringPBEConfig{
     ...
     * default password will be used once the environment value doesn't exists.
     *
     ...
     * load the value for the password.
     * default password will be used once the property value doesn't exists.
     *
