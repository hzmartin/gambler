...
public class TimeUtils {
	 ...
	 */
	public static final int getTimeOfToday(int hour, int minutes, int seconds,
			int ampm) {
	...
	public static void main(String[] args) {
		System.out.println(TimeUtils.parseDate("20150122000000"));
	}
}
