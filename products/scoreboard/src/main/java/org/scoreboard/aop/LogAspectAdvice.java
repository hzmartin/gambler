...
import org.scoreboard.annotation.LogMethod;
...
public class LogAspectAdvice {
	...
	@Before(value = "org.scoreboard.aop.SystemAspect.anyMethod()")
	public void doBefore(JoinPoint jp) {
		MethodSignature joinPointObject = (MethodSignature) jp.getSignature();
		Method method = joinPointObject.getMethod();
		logger.debug("log in method: " + method);
		...
		logString.append("执行方法：  " + jp.getTarget().getClass().getName() + "#"
